...
import { CreateVideos1789324957302 } from './migrations/1789324957302-CreateVideos';
...
describe('Database migrations (integration)', () => {
  ...
  beforeAll(async () => {
    ...
    // Run sequentially: concurrent DDL on interdependent catalog objects
    // (e.g. dropping a table alongside the enum type its column depends on)
    // can trigger a Postgres deadlock when run in parallel via Promise.all.
